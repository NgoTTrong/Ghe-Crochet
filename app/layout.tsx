...
export const metadata: Metadata = {
  ...
  keywords: [
    'crochet', 'handmade', 'đan móc', 'thủ công', 'amigurumi',
    'len', 'búp bê', 'thú bông', 'phụ kiện', 'quà tặng', 'Việt Nam',
  ],
  ...
  openGraph: {
    ...
    description:
      'Khám phá những sản phẩm đan móc thủ công tuyệt đẹp, được làm nên bằng tình yêu. Từ những món amigurumi dễ thương đến các phụ kiện tiện dụng, mỗi tác phẩm đều mang trong mình một câu chuyện.',
    images: [{ url: '/main-image.jpg', width: 1200, height: 630, alt: 'Ghẹ Crochet' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Ghẹ Crochet - Handmade with Love',
    description: 'Khám phá những sản phẩm đan móc thủ công tuyệt đẹp, được làm nên bằng tình yêu.',
