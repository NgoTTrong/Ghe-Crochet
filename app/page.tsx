              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <h1 className="text-4xl lg:text-6xl font-bold leading-tight text-balance">
                    Khám phá thế giới
                    <span className="gradient-text block">Crochet đáng yêu</span>
                  </h1>
                  <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                    Mỗi sản phẩm tại Ghẹ Crochet đều được tạo ra bằng tay với tình yêu và sự tỉ mỉ. Từ những chú
                    amigurumi dễ thương đến các phụ kiện thực dụng, chúng tôi mang đến những món quà độc đáo cho cuộc
                    sống của bạn.
                  </p>
                </div>
        ...
        <section className="py-16 lg:py-24 bg-muted/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-4 mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold">Được yêu thích nhất</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <Card className="border-0 cute-shadow bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5">
              <CardContent className="p-8 lg:p-12 text-center space-y-6">
                <div className="space-y-4">
                  <h2 className="text-3xl lg:text-4xl font-bold">Bạn có ý tưởng riêng?</h2>
                  <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
                    Chúng tôi nhận đặt hàng theo yêu cầu. Hãy chia sẻ ý tưởng của bạn và chúng tôi sẽ biến nó thành hiện
                    thực!
                  </p>
                </div>
